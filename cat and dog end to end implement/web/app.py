...
def load__model():
    ...
    with sess.as_default():
        with graph.as_default():
            #model = tf.keras.models.load_model(MODEL_FOLDER + '/cats_dogs_model.h5')
            model = tf.keras.models.load_model(MODEL_FOLDER + '/cats_dogs_modelnew.h5')
    # model = load_model(MODEL_FOLDER + '/cats_dogs_model.h5')
    # global graph
    # graph = tf.get_default_graph()
